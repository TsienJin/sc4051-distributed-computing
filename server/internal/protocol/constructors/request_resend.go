...
// NewRequestResend creates a packet to send as an acknowledgement packet.
func NewRequestResend(
	...
	h, err := protocol.NewPacketHeader(
		...
		protocol.PacketHeaderWithMessageType(proto_defs.MessageTypeRequestResend),
